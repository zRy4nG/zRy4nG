...
Concluí o **ensino médio técnico em Informática** pelo **IFCE – Campus Aracati** e atualmente estou cursando **Bacharelado em Ciência da Computação** na **UFERSA**.
...
com foco em **desenvolvimento web**, abrangendo **front-end**, **back-end** e **estruturação de dados**,  
além de **programação de servidores para MTA**.
